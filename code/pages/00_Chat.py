...
try :
    ...
    input_text = st.text_input("You: ", placeholder="type your question testing", value=st.session_state.chat_askedquestion, key="input"+str(st.session_state ['input_message_key']), on_change=questionAsked)
